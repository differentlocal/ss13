...
/proc/event()
	switch(rand(1,7))
		...
		if(5)
			event = 1
			command_alert("Вблизи станции выЯвлен высокий уровень радиации. Пожалуйста, обратитесь в мед.отсек если вы себЯ странно чувствуете.", "Внимание! РадиационнаЯ опасность")
